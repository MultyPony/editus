...
<!--        <div>
    ...
    <div id="buttonskip">
        ...
        <p>
            ...
            <!-- <a href="<?php echo "//editus.ru/cover-editor/cover-editor.html?width=$cover_width&height=$cover_height&spine=$spine&orderid=$orderid&title=$title&author=$author" ?>" target="_blank" class="button"> -->
            <a href="<?php echo "$editorUrl" ?>" class="button">
                Выбрать
            </a>
        </p>
