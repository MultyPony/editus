        ...
        <form method="post" action="<?php echo $action; ?>" style="font-family: Palatino Linotype,Book Antiqua,Times New Roman;">
            ...
            <div  id="delivery" style="display: none;" class="validate-form">
                                                ...
                                                <label class="inline-label cdek-label">
                                                    <input type="radio" name="typedeliv" value="pickup-point" onclick='cartWidjet.open()'/> Пункты выдачи
                                                </label>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: left; vertical-align: middle;">
                                    <input id="so1_pvz_address" type="text" name="so1_pvz_address" readonly>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right; width:35%">
                                ...
                                <td style="text-align: left; vertical-align: middle;">
                                    <input id="so1_delivery_price" type="text" readonly>
                                    <input id="hidden_del_price" type="hidden" value="0" name="so1_delivery_price"/>
                                    <input id="hidden_del_citytoid" type="hidden" value="0" name="so1_delivery_citytoid"/>
                                </td>
                            </tr>
                        </tbody>
                    </table>
