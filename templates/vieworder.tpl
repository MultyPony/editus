...
<!--            <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VO_BLOCKPRICE;?></td><td style="text-align: left; vertical-align: middle;"><?php echo $data['orderPriceBlock'].' '._VO_RUB; ?></td></tr>
        ...
        <?php } else if ($data['DeliveryProviderId']==18) { ?>
                <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VO_PROVIDER;?></td><td style="text-align: left; vertical-align: middle;"><?php echo $namedeliv; ?></td></tr>
                <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VO_ADDRESS;?></td><td style="text-align: left; vertical-align: middle;"><?php echo $dataadres['addressStr']; ?></td></tr>
                <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VO_DELIVPRICE;?></td><td style="text-align: left; vertical-align: middle;"><?php echo $data['orderPriceDeliver'].' '._VO_RUB; ?></td></tr>
        <?php } else { ?>
