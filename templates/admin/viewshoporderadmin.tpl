<fieldset>
    ...
    <?php if ($data['orderstep']>0){?>    
        ...
        <?php }else if ($data['DeliveryProviderId']==18) { ?>
            <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VSOA_PROVIDER;?></td><td style="text-align: left; vertical-align: middle;"><?php echo $namedeliv . " " . $dataadres['addressIndex']; ?></td></tr>
                <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VSOA_ADDRESS;?></td><td style="text-align: left; vertical-align: middle;"><?php echo $dataadres['addressStr'] . " " . $dataadres['addressIndex']; ?></td></tr>
