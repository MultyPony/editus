<fieldset>
    ...
    <?php if ($data['orderstep']>0){?>    
        ...
        <?php } else if ($data['DeliveryProviderId']==18) { ?>
                <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VSO_PROVIDER;?></td><td style="text-align: left; vertical-align: middle;"><?php echo $namedeliv; ?></td></tr>
                <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VSO_ADDRESS;?></td><td style="text-align: left; vertical-align: middle;"><?php echo $dataadres['addressStr']; ?></td></tr>
                <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VSO_DELIVPRICE;?></td><td style="text-align: left; vertical-align: middle;"><?php echo $data['orderPriceDeliver'].' '._VSO_RUB; ?></td></tr>
        <?php } else { ?>
