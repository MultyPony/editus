...
if (!empty($_POST['images'])) {
    ...
    $main_path = __DIR__ . "/../uploads/" . $_SESSION['userId'] . "/" . $orderid;
    ...
    $res = null;
    exec("convert $main_path/img1.jpg $main_path/img2.jpg $main_path/img3.jpg +append $main_path/combined.jpg", $res);
    ...
    exec('gs -o ' . $main_path . '/' . 'cmyk_' . $cover_pdf . ' -sDEVICE=pdfwrite -sProcessColorModel=DeviceCMYK -sColorConversionStrategy=CMYK -sColorConversionStrategyForImages=CMYK ' . $main_path . '/' . $cover_pdf, $res);
    ...
    // header("Location: /editus.php?do=orderstep4");
    echo "ok";
    die();
} else {
    echo "No Data Sent";
