<fieldset id="os2">
    ...
    <form method="post" action="<?php echo $action; ?>" style="margin: 0;">
        ...
        <p><?php echo _OS2_TEXT; ?><?php echo _OS2_TEXT3;?>
            <a class="more-link" target="_blank" href="new/cover.html"><?php echo _OS2_TEXT2;?> <span
        ...
        <div>
            <?php if ($ftemplate['covdesign']!=1){ ?>
            <div>
                <div style="float:left; padding-right: 20px;"><a class="button"
                                                                 href="<?php echo $hrefcovertemplate; ?>"><?php echo _OS2_DOWNLOADTEMPL; ?></a>
                </div>
        ...
        <div id="coverlayout" style="display: none;">
            <table>
                <tr>
                    <td><?php echo _OS2_UPLOADEDFILE;?></td>
                    <td><a href="<?php echo $hrefcover; ?>"><?php echo _OS2_DOWNLOAD;?></a></td>
                </tr>
                <tr>
                    <td><?php echo _OS2_LAYOUT;?></td>
                    <td><a href="<?php echo $hrefcoverpdf; ?>" target="_blank"><?php echo _OS2_DOWNLOAD;?></a></td>
                </tr>
            </table>

            <div class="alert">
                <?php echo _OS1_ADOBEREADER;?>&nbsp;<a target="_blank" href="//get.adobe.com/reader/"><img
                            style="height:25px; vertical-align: bottom;" src="img/get_adobe_reader.gif"
                            alt="Adobe Reader"/></a>
            </div>
        ...
        <div>
            ...
            <p id="os2_agreement" style="display: none;"><input type="checkbox" name="agreement"
                                                                id="os2_agreement_ch"/> <?php echo _OS2_AGREEMENT; ?>
            </p>

            <input type="submit" style="display: none;" class="button red" id="tonextstep"
                   value="<?php echo _OS2_NEXTSTEP; ?>"/>
            <?php }else{ ?>
            <br>
    ...
    <div id="buttonskip">
        ...
        <br>
        <p>
            <h4>Редактор обложки</h4>
            <!-- <br> -->
            <p>Выберите редактор обложки</p>
            <!-- <br> -->

            <!-- <a href="<?php echo "//editus.ru/test/cover-editor/cover-editor.html?width=$cover_width&height=$cover_height&spine=$spine&orderid=$orderid&title=$title&author=$author" ?>" target="_blank" class="button"> -->
            <a href="<?php echo "$editorUrl" ?>" target="_blank" class="button">
                Выбрать
            </a>
        </p>
