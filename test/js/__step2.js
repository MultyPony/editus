...
//        
            ...
            $.post('include/project_ajax.php',
                {
                    ...
                    'paperTypeWeight' : $('input[name=paperblock]:checked').data('weight'),
                    'pages' : $('#softpages').val(),
                    'count' : $('#softcount').val(),
                    ...
                    'papertype_cover' : $('input[name=binding]:checked').data('coverType'), 
                    'lamination' : $('input[name=lamination]:checked').val(),
                    'isbnChecked' : Boolean($('#isbn-checkbox').is(':checked')),
                    'delivery_type' : deliveryType,
                    'city_id_for_CDEK' : deliveryType == 'pickup-point' ? $('#hidden_del_citytoid').val() : false,
                    'os3_providers': $('select[name=os3_providers]').val(),
                }, function(data) {
                    ...
                    if (deliveryType == 'pickup') {
                        ...
                        $('.total-print').text(response.total);
                        $('.total').text((+response.total) + (+response.deliveryCost));
                    }
        ...
        $('#saveandselnewaddress').click(function(){
            $.post(main_file_name+'?do=orderstep2',{'do':'savenewaddress',
