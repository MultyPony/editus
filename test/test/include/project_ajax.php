    ...
    ?>
        ...
        <table width="100%">
            ...
            if ($_POST['do'] == 'getPaperTypeBind') {
                ...
                $db->query(
                    "SELECT BindingType.BindingId, BindingType.BindingName, CoverType 
        ...
        <?php
            ...
            if ($_POST['do'] == 'calc') {
                ...
                $format_width = $row['formatWidth'];
                $format_height = $row['formatHeight'];
                ...
                $massa = ($_POST['paperTypeWeight'] * (($format_width * $format_height) / 1000000000) * $count * ($pages / 2 + 10)) * 1000;

                if ($_POST['delivery_type'] == 'pickup') {
                    $delivcost = 0;
                } else if ($_POST['delivery_type'] == 'deliver') {                    
                    ...
                    // $delivcost = 0;
                } else if ($_POST['delivery_type'] == 'pickup-point') {
