                    ...
                    <tbody>
                        <tr>
                            <td>
                                ...
                                <label>
                                    <input id="isbn-checkbox" type="checkbox" name="additionalservice[]" value="10"> Издательский пакет (ISBN, номера УДК, ББК, авторский знак, 16 обязательных экземпляров книги в РКП (Федеральный Закон "Об обязательном экземпляре документов") ( <a href="http://www.bookchamber.ru/oe.html" target="_blank">?</a> )
                                </label>
                            </td>
                        </tr>
                    </tbody>
        ...
        <div class="entry-content" id="add" style="display: none;">
            <div id="total">
                ...
                <table width="100%">
                    ...
                    <table class="total-calc">
                        <tr>
                            <td>Стоимость печати тиража: </td>
                            <td><span class="total-print"></span> руб.</td>
                        </tr>
                        <tr>
