<fieldset>
    ...
    <table>
        <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VOA_OREDERNAME;?></td><td style="text-align: left; vertical-align: middle;"><?php echo isset($data['orderName']) ? $data['orderName'] : ''; ?></td></tr>
        <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VOA_AUTHOR;?></td><td style="text-align: left; vertical-align: middle;"><?php echo isset($data['orderAutor']) ? $data['orderAutor'] : ""; ?></td></tr>
        ...
        <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VOA_COVER;?></td><td style="text-align: left; vertical-align: middle;"><?php echo isset($covers[$data['orderCover']]) ? $covers[$data['orderCover']] : ""; ?></td></tr>
        <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo "Ламинация:";?></td><td style="text-align: left; vertical-align: middle;"><?php echo ""; ?></td></tr>
        <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VOA_FORMAT;?></td><td style="text-align: left; vertical-align: middle;"><?php echo isset($data['formatName']) ? $data['formatName'] : ""; ?></td></tr>
        <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VOA_PAPERTYPE;?></td><td style="text-align: left; vertical-align: middle;"><?php echo (isset($data['PaperTypeName']) ? $data['PaperTypeName'] : '') .' '. (isset($data['PaperTypeWeight']) ? $data['PaperTypeWeight'] : ""); ?></td></tr>
        <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VOA_BIND;?></td><td style="text-align: left; vertical-align: middle;"><?php echo (isset($data['BindingName']) ? $data['BindingName'] : ""); ?></td></tr>
        <tr><td style="text-align: right; vertical-align: middle; width: 250px;"><?php echo _VOA_COLOR;?></td><td style="text-align: left; vertical-align: middle;"><?php echo (isset($data['PrintTypeName']) ? $data['PrintTypeName'] : ""); ?></td></tr>
