...
<!-- <script src="https://code.jquery.com/jquery-migrate-3.3.2.js"></script> -->
  	<!-- STYLES -->
    <link rel="stylesheet" type="text/css" media="print" href="new/css/print.css">
    ...
    <!-- <link rel="stylesheet" type="text/css" href="//<?php echo isset($_SERVER['HTTP_X_FORWARDED_HOST']) ? $_SERVER['HTTP_X_FORWARDED_HOST'] : $_SERVER['SERVER_NAME'];?>/new/css/main.css"> -->
